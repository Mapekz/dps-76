...
- Issue titles and bodies use the vocabulary defined in `CONTEXT.md` — say **OMOD**, not "attachment"; **Bucket**, not "category"; **Scenario** (Manual/VATS/Sneak), not "mode". See `docs/agents/domain.md`.
