  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block bg-background ring-0 transition-transform group-data-[size=default]/switch:size-3.5 group-data-[size=sm]/switch:size-2.5 dark:data-checked:bg-primary-foreground data-checked:translate-x-[calc(100%+2px)] data-unchecked:translate-x-0.25 dark:data-unchecked:bg-foreground"
      />
    </SwitchPrimitive.Root>
  );
}
